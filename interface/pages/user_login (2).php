        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title">Sign In to Social Book</div>
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form" method = "POST" action = "login.php">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input id="login-username" type="text" class="form-control" name="user_email" value="" placeholder="email123@domain.com">
                                    </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 control">
                                        ...
                                        <a href="index.php" onClick="$('#loginbox').hide(); $('#signupbox').show()">
                                            Sign Up Here
                                        </a>
                                        </div>
                                    </div>
