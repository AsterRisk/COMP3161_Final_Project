                    ...
                    <div class="w3-row-padding" style="margin:0 -16px">
                        <div class="w3-half">
                            ...
                            <?php
                                ...
                                if($isMember)
                                {
                                    $comment = "<br><input type = 'text' id = 'comment|". $gp['g_post_id'] ."' class = 'comment' name = 'comment' placeholder = 'Write a comment...' rows = 100>\n\n <input type = 'text' id = 'hidden|". $gp['g_post_id'] ."' class = 'post_identifier' name = 'hidden_val' hidden = 'true' value = ". $gp['g_post_id'] .">" . "<input type = 'text' id = 'hidden|". $gp['group_id'] ."' class = 'post_identifier' name = 'group_id' hidden = 'true' value = ". $gp['group_id'] .">";
                                    echo $comment;
