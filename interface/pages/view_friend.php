...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <!-- Right Column -->
    <div class="w3-col m2" style = "display:none;">
      <br>
          ...
          <h4><b>Friend Requests:</b></h4>
            <?php
                ...
                foreach($friendReqs as $request)
                {
                    if(($post['media_link'] != NULL) && ((strcasecmp($post['media_link'], "NULL")) != 0))
                    {
                        $img = "<img src=\"". $request['profile_pic_address']."\" style=\"width:100%\" alt=\"IMAGE.PNG\" class=\"w3-margin-bottom\">";
                        echo $img;
                    }
                    else
                    {
                        $img = "<img src=\"../assets/default_imgs/default_profile_picture.png \" style=\"width:30%\" alt=\"IMAGE.PNG\" class=\"w3-margin-bottom\">";
                        echo $img;
                    }
